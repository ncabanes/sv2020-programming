...
// Versión previa, sólo ordena por nombre de ciudad,
// para usar .Sort e IComparable
...
class Ejercicio165a
{
    struct DatosCiudad : IComparable<DatosCiudad>
    {
        public string nombre;
        public string pais;
        public int poblacion;

        public int CompareTo(DatosCiudad otra)
        {
    ...
    static void RevisarErroresOrtograficos(List<DatosCiudad> ciudades)
    {
        ...
        for (int i = 0; i < ciudades.Count; i++)
        {
            ...
            // Nota: planteamiento alternativo al de la versión 2
            bool repetido = false;
            for (int j = 0; j < ciudades[i].nombre.Length-3; j++)
            {
