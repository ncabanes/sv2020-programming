...
class Ejercicio_77
{
    ...
    static void Main()
    {
        ...
        contDomestica[] ingreso = new contDomestica[MAX_INGRESOS];
        bool salir = false;
        int registros = 0;
            ...
            switch (opcion)
            {
                case "1":  // Añadir
                    if (registros < MAX_INGRESOS)
                    {
                        ...
                        do
                        {
                            ...
                            ingreso[registros].fecha = leerFecha;
                        }
                        while ( ! fechaCorrecta );
                        ...
                        do
                        {
                            ...
                            ingreso[registros].descripcion = Console.ReadLine();

                            if (ingreso[registros].descripcion == "")
                            {
                                Console.WriteLine("No puede estar vacía");
                                Console.WriteLine();
                            }
                        }
                        while (ingreso[registros].descripcion == "");

                        Console.Write("Categoría: ");
                        ingreso[registros].categoria = Console.ReadLine();

                        Console.Write("Ingreso: ");
                        ingreso[registros].importe =
                            Convert.ToDouble(Console.ReadLine());
                        Console.WriteLine(ingreso[registros].importe);
                        registros++;
                    }
                    else
                    {
                ...
                case "4":  // Modificar
                    ...
                    else
                    {
                        ...
                        if (respuesta != "")
                        {
                            ingreso[modRegistro].fecha = respuesta;
                        }
                        Console.WriteLine();
                        ...
                        if (respuesta != "")
                        {
                            ingreso[modRegistro].descripcion = respuesta;
                        }
                        Console.WriteLine();
                        ...
                        if (respuesta != "")
                        {
                            ingreso[modRegistro].categoria = respuesta;
                        }
                        Console.WriteLine();
                ...
                case "7":  // Normalizar descripciones
                    ...
                    {
                        ingreso[x].descripcion = ingreso[x].descripcion.Trim();
                    }
                    ...
                    for (int x = 0; x < registros; x++)
                    {
                        ...
                        {
                            ingreso[x].descripcion =
                                ingreso[x].descripcion.Replace("  ", " ");
                        }
                    }
                    ...
                    for (int x = 0; x < registros; x++)
                    {
                        ...
                        {
                            ingreso[x].descripcion =
                                ingreso[x].descripcion.Substring(0,1) +
                                ingreso[x].descripcion.Substring(1).ToLower();
                        }
                    }
